...
Vue.component("dark_header_component_1722619261", {
    template: `
    <header id="header-component" class="z-30 bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 backdrop-filter backdrop-blur-lg bg-opacity-30">
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div id="site-branding" class="shrink-0 mr-4 lg:fixed">
                    ...
                    <a class="flex items-center space-x-4" href="index.html" aria-label="Cruip">
                        <img id="site-logo" class="rounded-full border-2 border-white shadow-lg" src="./images/logo.jpg" width="32" height="32" alt="Mary Rutt">
                        <span id="site-name" class="text-white font-bold text-xl tracking-wide">Satoshi Nakamoto</span>
                    </a>
                </div>
                <!-- Right side -->
                <div id="right-side" class="flex grow justify-end">
                    ...
                    <div id="light-switch-container" class="flex flex-col justify-center">
                        ...
                        <label id="light-switch-label" class="relative cursor-pointer h-10 w-10 inline-flex items-center justify-center rounded-full bg-white bg-opacity-20 border border-white border-opacity-30 hover:bg-opacity-30 shadow-lg transition-all duration-300" for="light-switch">
